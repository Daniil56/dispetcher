...
public class DispatcherTestContainer extends TestContainer {

    public DispatcherTestContainer() {
        super();
    ...
    public static class Common extends DispatcherTestContainer {

        public static final DispatcherTestContainer.Common INSTANCE = new DispatcherTestContainer.Common();
